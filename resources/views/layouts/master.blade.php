...
<!--/ News end -->
  ...
  <script type="text/javascript" src="{{ asset('plugins/slick/slick-animation.min.js') }}"></script>
  <!-- Color box -->
  <script type="text/javascript" src="{{ asset('plugins/colorbox/jquery.colorbox.js') }}"></script>
  <!-- shuffle -->
  <script type="text/javascript" src="{{ asset('plugins/shuffle/shuffle.min.js') }}"></script>
  ...
  <script type="text/javascript" src="{{ asset('plugins/google-map/map.js') }}"></script>
